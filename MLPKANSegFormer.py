...
from MLPKANDecoder import MLPKANDecoder
from EncoderBlock1 import EncoderBlock1
from EncoderBlock import EncoderBlock


class MLPKANSegFormer(nn.Module):
    ...
    def __init__(self, input_height, class_num):
        ...
        self.EncBlock4 = EncoderBlock(in_channels=16,
                                      ...
                                      explanation_ratio=1,
                                      CALayer_num=2)
        self.Dec = MLPKANDecoder(4, 8, 16, 32, class_num)
    ...
    def forward(self, x):
        ...
        out = self.Dec(x1, x2, x3, x4)  # Pass individual outputs to the decoder
